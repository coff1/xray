XRAY Web Vulnerability Scanner Windows amd64 -Zen
...
This is a Pro feature but with the crack you are good to go.  You need "rad.exe"
...
read the docs and edit the yaml file.
...
example usage basic scan without rad/chrome:
  xray.exe ws --basic http://example.com --html-output example.html

example usage with rad/chrome:
  xray.exe ws --browser https://www.ai.mil/ --json-output algorithmicwarfare.json
